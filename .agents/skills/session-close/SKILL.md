---
name: session-close
description: Use at the end of a working session to leave the repo in a clean, resumable state. Covers active docs, AGENTS.md, memory, git, and handoff.
---
...
Ask: *could a new session read README.md, ARCHITECTURE.md, AGENTS.md, and git status and know exactly where to resume?*
